...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    cleaned_ingredients = set(dish_ingredients)
    return (dish_name, cleaned_ingredients)
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    dish_categories = {
        ...
        "PALEO": frozenset(PALEO),
        "KETO": frozenset(KETO),
        "OMNIVORE": frozenset(OMNIVORE)
    }
    for category, item in dish_categories.items():
...
def tag_special_ingredients(dish):
    ...
    special_ingredients = dish_ingredients & SPECIAL_INGREDIENTS
...
def compile_ingredients(dishes):
    ...
    master_set = set()
    for item in dishes:
        master_set = master_set.union(item)
    return master_set    
...
def separate_appetizers(dishes, appetizers):
    ...
    return list(set_of_dishes.difference(set_of_appetizers))
...
def singleton_ingredients(dishes, intersection):
    ...
    big_set = set()
    for dish in dishes:
        big_set = big_set.union(dish)
    return big_set.difference(intersection)
